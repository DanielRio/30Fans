; (function () { 
    ...
    Fans.Products.init = function(html){
        ...
        var ddProducts = this.html.find('#ddProducts');
        var uploadFile = this.html.find('#uploadFile');
        var submit = this.html.find('#submit');
        var uploadPhotoFieldset = this.html.find('#uploadPhotoFieldset');
